...
export function Topbar() {
  ...
  return (
    <header className="sticky top-0 z-20 flex h-14 items-center border-b border-zinc-800 bg-zinc-950/90 px-4 backdrop-blur">
      <button
        onClick={toggle}
      ...
      <div className="ml-3 flex items-center gap-2 rounded-md border border-zinc-800 bg-zinc-900 px-2 py-1 text-zinc-400">
        <Search size={14} />
        <input
